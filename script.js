...
// Load table contents
    ...
    var loadUrl =  "incidents.htm"; //"http://incidents.routetodigitallive.com/incidents?Priority=Low&First%20Name=Lucy"; 
	...
	$("#result").html(ajax_load).load(loadUrl, queryString, function(){checkColumns(); drawChart(); });
});	
